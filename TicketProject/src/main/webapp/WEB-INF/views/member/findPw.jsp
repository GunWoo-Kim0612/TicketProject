...
<body>
    ...
    <div class="container" style="width: 800px;">
        <form class="mt-5" action="findPw.do" method="post">
            <div class="card text-white bg-dark mb-3">
                ...
                <div class="card-body">
                    <ul class="nav nav-pills nav-fill navbar-dark bg-dark" style="margin-top: 15px">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="findUserId">아이디 찾기</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="findPw">비밀번호 찾기</a>
                        </li>
                    </ul>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h6 class="card-subtitle mb-2 text-muted">회원님의 정보로 비밀번호 찾기</h6>
                ...
                <p id="result_pw" align="center">${pw}</p]>
                </div>
                <input type="submit" class="btn btn-secondary" value="비밀번호 찾기">
            </div>
